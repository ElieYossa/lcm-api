...
const DriverCtrl = __importStar(require("../controllers/driver.controller"));
const auth_middleware_1 = require("../../../shared/middlewares/auth.middleware");
const Driverrouter = (0, express_1.Router)();
Driverrouter.use(auth_middleware_1.protect);
Driverrouter.use((0, auth_middleware_1.restrictTo)('driver', 'admin'));
